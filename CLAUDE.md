...
## STEP 0 — Read DESIGN_FIRST.md before anything else

**This is not optional. Do not proceed until you have read `DESIGN_FIRST.md` in full.**

After reading it, you must be able to answer these five questions. If you cannot answer them from memory, go back and read again:

1. What are the three container types and when does each one apply?
2. How many font families are permitted, and what is each one used for?
3. What is the rule for Agrandir? Where is it permitted and where is it forbidden?
4. What is the rule for the primary action button — how many, what colour, where?
5. What does "one title per surface" mean?

Do not output the answers. Just confirm you have read the file by writing:
> "DESIGN_FIRST.md read. Proceeding."

Then continue to the questionnaire below.
